...
export default function ClientGalleryPage({ params }: { params: Promise<{ token: string }> }) {
  ...
  async function handleFavoriteToggle(photoId: string) {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        // Token rejected — clear session and re-prompt for identity
  ...
  return (
    ...
    >
      ...
      {clientToken && (
        <div className="fixed bottom-5 right-5 z-30 pointer-events-auto" style={chromeFade}>
          <button
